...
public class Manage_Stocks extends javax.swing.JFrame {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(jComboBox_supplier_name, 0, 237, Short.MAX_VALUE)
                    .addComponent(jComboBox_medicine_name, 0, 237, Short.MAX_VALUE)
                ...
                .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jComboBox2_supplier_name, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel9Layout.createSequentialGroup()
                        .addGap(74, 74, 74)
        ...
        jPanel10Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jComboBox3_medicine_name, 0, 318, Short.MAX_VALUE)
    ...
    private void jButton_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_searchActionPerformed
        ...
        if(jXDatePicker1.getDate() != null) {
            ...
            Date = sysdate.format(jXDatePicker1.getDate()).toString();
        }
    ...
    private void jButton_update_stockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_update_stockActionPerformed
        ...
        SimpleDateFormat sysdate = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss"); 
        String date = sysdate.format(jXDatePicker2.getDate()).toString();
        try(Connection conn = MySQL_Connector.getConnection()) {
    ...
    private void jButton_delete_stockActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_delete_stockActionPerformed
        SimpleDateFormat sysdate = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss"); 
        String date = sysdate.format(jXDatePicker3.getDate());
