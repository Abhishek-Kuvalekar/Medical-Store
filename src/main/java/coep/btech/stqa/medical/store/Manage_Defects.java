...
public class Manage_Defects extends javax.swing.JFrame {
        ...
        jPanel7Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel7Layout.createSequentialGroup()
                ...
                .addGroup(jPanel7Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jXDatePicker1_return, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
            .addGroup(jPanel7Layout.createSequentialGroup()
                .addGap(132, 132, 132)
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jComboBox1_medicine_name, 0, 309, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGap(82, 82, 82)
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jTextField_amount_received, javax.swing.GroupLayout.DEFAULT_SIZE, 232, Short.MAX_VALUE)
    ...
    private void jButton_search2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_search2ActionPerformed
        ...
        if(jXDatePicker1_return.getDate() != null) {
            SimpleDateFormat sysdate = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
            Date = sysdate.format(jXDatePicker1_return.getDate()).toString();
        }
    ...
    private void jButton_add_entryActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_add_entryActionPerformed
        //SimpleDateFormat sysdate = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss");
        String Date = jTextField1.getText();//sysdate.format(jXDatePicker1_return.getDate());
        try(Connection conn = MySQL_Connector.getConnection()){ 
