    ...
    private void validateForm() {
        ...
        try(Connection conn = MySQL_Connector.getConnection()) {
            ...
            if(rs.next()) {
                ...
                if(rs1.next()) {
                    if(role.equalsIgnoreCase(rs1.getString("role_name"))) {
                        ...
                        JOptionPane.showMessageDialog(null, "Error Innermost: Invalid Username or Password!");
                    }
                }
                else {
                    JOptionPane.showMessageDialog(null, "Error Inner: Invalid Username or Password!");
                }
            }
            else {
                JOptionPane.showMessageDialog(null, "Error Outer: Invalid Username or Password!");
            }
